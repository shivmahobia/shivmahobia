...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Shiv%20Mahobia&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Full-Stack%20Developer%20%7C%20Builder%20%7C%20India%20%F0%9F%87%AE%F0%9F%87%B3&descAlignY=58&descSize=18&animation=fadeIn" />
...
const shiv = {
  ...
  currentProjects: [
    "🔥 Krackdeal  — deal discovery platform",
    "🪪 e-KYD      — digital KYC/KYD system",
  ],

  learning:  ["React Native", "System Design"],
  interests: ["Open Source", "SaaS", "Dev Tools"],

  funFact:   "I ship in dark mode. Always. 🌙",
  openTo:    ["collaborations", "freelance", "ideas"],
};
```
...
**🔥 Krackdeal**
> Deal aggregation & discovery platform. Find the best prices across the web in one place.
...
**🪪 e-KYD**
> Digital Know Your Data verification system. Secure, fast, and paperless identity workflows.

`Next.js` `TypeScript` `REST API` `Auth`
...
<img src="https://skillicons.dev/icons?i=react,nextjs,angular,typescript,javascript,html,css,bootstrap,flutter&theme=dark" />

<br/><br/>

**Backend & Database**

<img src="https://skillicons.dev/icons?i=nodejs,express,python,mongodb,mysql,firebase&theme=dark" />

<br/><br/>

**Tools & DevOps**

<img src="https://skillicons.dev/icons?i=docker,git,github,figma,postman,vscode&theme=dark" />
